...
const ParkingShareInfo = () => {
  return (
    <div className="parking-share-info">
      ...
      <p>거주자우선(주거지)주차공간이나, 사유지 주차공간을 공유하시고 적립금 쌓으세요!</p>
      ...
      <p>자신이 주차장을 쓰지 않는 시간에 다른 사람에게 그 자리를 대여하면 적립금가 쌓입니다.</p>
      <p>비어있는 자신의 자리를 효율있게 공유하세요!</p>
      <br/>
      <h2>주차장 공유의 혜택</h2>
      <p>자신의 주차장을 다른 사용자가 사용하면 일정 금액의 적립금을 드립니다!</p>
      <div className="image-container">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShkubV-beuH4g96vAX1m-ZKBbpZpZkj7U35Q&s" alt="주차장 공유 인센티브 이미지" />
      </div>
      <br/>
      <h2>주차장 등록하는 법</h2>
