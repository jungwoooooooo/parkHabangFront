...
const IllegalParkingInfo = () => {
  ...
  return (
    <div className="main-content">
      <animated.h1 style={textAnimation}>불법주차 구역 정보</animated.h1>
      <br/>
      <animated.h3 style={textAnimation}>5대 불법 주정차 금지구역</animated.h3>
      <animated.p style={textAnimation}>아래 5구역은 절대 주차하면 안 되는 구역으로 지정되어 있습니다. <br/>잠시 정차도 허용되지 않는 곳이니 이런 곳에 주차된 차량은 바로 신고하시면 됩니다.</animated.p>
      <br/>
      ...
      />
      <br/><br/>
      <animated.h3 style={textAnimation}>도로 노면에 표시된 선으로 불법 여부 파악하기</animated.h3>
      <animated.p style={textAnimation}>신고하려는 차량이 불법인지 아닌지 파악하는 방법은 도로 노면에 표시된 선으로 쉽게 파악하실 수 있습니다.</animated.p>
      <ul style={{ listStylePosition: 'inside' }}>
      ...
      />
      <br/><br/>
      <animated.h3 style={textAnimation}>불법 주정차 신고대상</animated.h3>
      <ul style={{ listStylePosition: 'inside' }}>
